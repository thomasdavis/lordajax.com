...
1) BIO
2) MEMORIES
3) DEFAULT_CONVERSATION (a static manually defined conversation)
4) PREVIOUS_CONVERSATION (the last 6-8 messages saved)
5) NEW_TRANSCRIPTION (the latest speech to text)
```
